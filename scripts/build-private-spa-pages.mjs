...
const variants = {
  ko: {
    ...
    replacements: {
      ...
      'BODY &amp; FACIAL':'바디 &amp; 페이셜','Body and facial care programs.':'바디와 페이셜 관리 프로그램.','AIRE SPA offers body and facial treatments in Gangnam, including body care, facial care, and face-and-body programs. Guests looking for facial and massage services in Gangnam can review current durations, inclusions and prices on the Programs page.':'바디케어, 페이셜케어, 페이스·바디 프로그램을 운영합니다. 현재 프로그램별 시간, 포함 항목과 가격은 프로그램 페이지에서 확인할 수 있습니다.','VIEW PROGRAMS':'프로그램 보기',
      ...
      'Is AIRE SPA available by reservation?':'AIRE SPA는 예약제로 운영하나요?','Yes. AIRE SPA operates by reservation.':'네. AIRE SPA는 예약제로 운영합니다.','Are the treatment rooms private?':'관리실은 독립된 공간인가요?','Yes. Appointments take place in private rooms, with separate rooms available for individual and couple visits.':'네. 모든 관리는 독립된 공간에서 진행하며 1인실과 2인실을 각각 운영합니다.','What types of care are available?':'어떤 관리 프로그램이 있나요?','AIRE SPA offers body care, facial care, and face-and-body programs. Current program details, durations and prices are listed on the Programs page.':'바디케어, 페이셜케어, 페이스·바디 프로그램을 운영합니다. 현재 프로그램 구성, 시간과 가격은 프로그램 페이지에서 확인할 수 있습니다.','Is AIRE SPA a medical spa?':'AIRE SPA는 메디컬 스파인가요?','No. AIRE SPA is a non-medical spa focused on body care, facial care, massage-based services and relaxation. It does not provide medical procedures.':'아니요. AIRE SPA는 바디케어, 페이셜케어, 마사지 기반 서비스와 휴식에 중점을 둔 비의료 스파이며 의료 시술을 제공하지 않습니다.','Do the private rooms have shower areas?':'프라이빗 룸 안에 샤워 공간이 있나요?','Yes. Each private room includes its own shower area.':'네. 각 프라이빗 룸 안에 샤워 공간이 마련되어 있습니다.','Where is AIRE SPA located?':'AIRE SPA는 어디에 있나요?','AIRE SPA is on the second floor at 14-15, Teheran-ro 78-gil, Gangnam-gu, Seoul 06194, Republic of Korea.':'AIRE SPA는 서울특별시 강남구 테헤란로78길 14-15, 2층에 있습니다.',
  ...
  ja: {
    ...
    replacements: {
      ...
      'Designed for a more<br>private appointment.':'よりプライベートな<br>時間のための空間。','AIRE SPA &amp; AESTHETIC is a non-medical private spa in Gangnam, Seoul, and operates by reservation.':'AIRE SPA &amp; AESTHETICはソウル・江南にある非医療系のプライベートスパで、予約制で運営しています。','Each appointment takes place in a private room, with separate rooms available for individual and couple visits.':'すべての施術は個室で行い、1名様用と2名様用のルームをご用意しています。',
      ...
      'BODY &amp; FACIAL':'ボディ &amp; フェイシャル','Body and facial care programs.':'ボディとフェイシャルのケア。','AIRE SPA offers body and facial treatments in Gangnam, including body care, facial care, and face-and-body programs. Guests looking for facial and massage services in Gangnam can review current durations, inclusions and prices on the Programs page.':'ボディケア、フェイシャルケア、フェイス＆ボディのプログラムをご提供しています。現在の所要時間、内容、料金はプログラムページでご確認いただけます。','VIEW PROGRAMS':'プログラムを見る',
      ...
      'Is AIRE SPA available by reservation?':'AIRE SPAは予約制ですか？','Yes. AIRE SPA operates by reservation.':'はい。AIRE SPAは予約制で運営しています。','Are the treatment rooms private?':'施術室は個室ですか？','Yes. Appointments take place in private rooms, with separate rooms available for individual and couple visits.':'はい。すべての施術は個室で行い、1名様用と2名様用のルームをご用意しています。','What types of care are available?':'どのようなケアがありますか？','AIRE SPA offers body care, facial care, and face-and-body programs. Current program details, durations and prices are listed on the Programs page.':'ボディケア、フェイシャルケア、フェイス＆ボディのプログラムがあります。現在の内容、所要時間、料金はプログラムページでご確認いただけます。','Is AIRE SPA a medical spa?':'AIRE SPAはメディカルスパですか？','No. AIRE SPA is a non-medical spa focused on body care, facial care, massage-based services and relaxation. It does not provide medical procedures.':'いいえ。AIRE SPAはボディケア、フェイシャルケア、マッサージを中心としたリラクゼーション目的の非医療系スパで、医療施術は提供していません。','Do the private rooms have shower areas?':'個室にシャワースペースはありますか？','Yes. Each private room includes its own shower area.':'はい。各個室にシャワースペースがあります。','Where is AIRE SPA located?':'AIRE SPAはどこにありますか？','AIRE SPA is on the second floor at 14-15, Teheran-ro 78-gil, Gangnam-gu, Seoul 06194, Republic of Korea.':'AIRE SPAはソウル特別市江南区テヘラン路78キル14-15、2階にあります。',
